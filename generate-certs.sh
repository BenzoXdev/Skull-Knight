#!/bin/bash
# Generate self-signed TLS certificates for Skull Knight
...
echo "  1. Set environment variable: SKULL_KNIGHT_TLS=true"
echo "  2. Optionally set custom paths:"
echo "     SKULL_KNIGHT_TLS_CERT=$CERT_DIR/server.crt"
echo "     SKULL_KNIGHT_TLS_KEY=$CERT_DIR/server.key"
echo ""
