@echo off
REM Generate self-signed TLS certificates for Skull Knight (Windows)
...
echo =========================================
echo Generating TLS Certificates for Skull Knight
echo =========================================
...
echo   1. Set environment variable: set SKULL_KNIGHT_TLS=true
echo   2. Optionally set custom paths:
echo      set SKULL_KNIGHT_TLS_CERT=%CERT_DIR%\server.crt
echo      set SKULL_KNIGHT_TLS_KEY=%CERT_DIR%\server.key
echo.
