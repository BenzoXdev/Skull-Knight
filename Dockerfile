...
# Skull Knight Server Dockerfile
...
COPY skull-knight-server/package.json skull-knight-server/bun.lock* ./

# Install dependencies
RUN bun install --frozen-lockfile

# Copy source code and client code (needed for builds)
COPY skull-knight-server/ ./
COPY skull-knight-client/ ./skull-knight-client/
