const BLOCK_CATEGORIES = {
  ...
  custom: {
    ...
    blocks: [
      ...
      { id: "echo", label: "Echo / Print", desc: "Print a message", ps: "Write-Host \"{message}\"", bash: "echo \"{message}\"", fields: [{ key: "message", label: "Message", placeholder: "Hello from Skull Knight" }] },
    ],
  },
};
