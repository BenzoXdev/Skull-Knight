const DISMISS_KEY = "SKULL_KNIGHT_cert_banner_dismissed";
...
function detectOS() {
  ...
  if (ua.includes("win")) {
    return {
      label: "Windows",
      instructions:
`1. Double-click the downloaded <strong>skull-knight-ca.crt</strong> file.
...
7. <strong>Restart your browser</strong> for the change to take effect.`,
  ...
  if (ua.includes("mac")) {
    return {
      label: "macOS",
      instructions:
`1. Double-click the downloaded <strong>skull-knight-ca.crt</strong> file — it opens in Keychain Access.
...
`<strong>Debian / Ubuntu:</strong>
  sudo cp skull-knight-ca.crt /usr/local/share/ca-certificates/skull-knight-ca.crt
  sudo update-ca-certificates

<strong>Fedora / RHEL:</strong>
  sudo cp skull-knight-ca.crt /etc/pki/ca-trust/source/anchors/skull-knight-ca.crt
