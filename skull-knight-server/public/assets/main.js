...
const PREF_FILTER_STATUS_KEY = "SKULL_KNIGHT_filter_status";
const PREF_SORT_KEY = "SKULL_KNIGHT_sort";
const PREF_FILTER_OS_KEY = "SKULL_KNIGHT_filter_os";
const PREF_FILTER_COUNTRY_KEY = "SKULL_KNIGHT_filter_country";
const PREF_FILTER_GROUP_KEY = "SKULL_KNIGHT_filter_group";
  ...
  try {
    ...
    if (res.ok) {
      ...
      if (currentUser && currentUser.username && currentUser.role) {
        ...
        if (currentUser.role === "admin" && !localStorage.getItem("SKULL_KNIGHT_settings_exported")) {
          localStorage.setItem("SKULL_KNIGHT_settings_exported", "1");
          try {
            ...
            if (expRes.ok) {
              ...
              const filename = match ? match[1] : "skull-knight-settings.json";
